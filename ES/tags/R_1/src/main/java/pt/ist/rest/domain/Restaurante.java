...
public class Restaurante extends
    ...
    public Double getMediaClassificacao() {
        ...
        try {
            if (numPratosParaClass < getPortalRestaurante().get_minPratosParaClassificarRest()) {
                ...
                media = (double) (acomulador / numPratos);
                return media;
            }
    ...
    public void adicionaPrato(String nomePrato,Double precoPrato,Double caloriasPrato,Integer classificacaoPrato,Integer idPrato) {
        try {
            if (getPratoSet().size() < getPortalRestaurante().get_maxPratosPorRestaurante()) {
                if (contemPrato(nomePrato)) {
                    ...
                    Prato p = new Prato(nomePrato, precoPrato, caloriasPrato, classificacaoPrato,
                            idPrato);
                    addPrato(p);
                }
            } else {
