...
public class Cliente extends
    ...
    public Compra getTabuleiro() throws NaoExisteTabuleiroException {
        if (hasTabuleiro()) {
            ...
            throw new NaoExisteTabuleiroException("Cliente nao contem tabuleiro", this.getNome()); //TODO: nao sei se tem que devolver o cliente, confirmem 
