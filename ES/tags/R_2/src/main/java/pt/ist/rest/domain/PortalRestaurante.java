...
public class PortalRestaurante extends
    ...
    public void adicionaPratoCliente(Prato p, String username, int quantidade) throws GestorAdicionaItemException {
    ...
    public void clienteFinalizaCompra(String username) {
        ...
        if (cl.hasTabuleiro()) {
            ...
            if (cl.get_saldo() >= c.getTotal()) {
                ...
                throw new UnknownError(); //TODO: Cliente Não tem saldo disponivel
            }
        } else {
            throw new UnknownError(); //TODO: Cliente Não contem Tabuleiro 
        }
    }
