...
@Override
    protected void setUp() {
        ...
        p1 = new Prato("Bacalhau com Natas", 2, 2,getPortal().generatePratoId());
        p2 = new Prato("Bacalhau a Bras", 3, 3,getPortal().generatePratoId());
        p3 = new Prato("Carninha", 70, 1,getPortal().generatePratoId());
        p4 = new Prato("Carne de Vaca", 7, 3,getPortal().generatePratoId());
        p5 = new Prato("Peixe embacalhau", 8, 60,getPortal().generatePratoId());
...
@Override
    ...
    public void testClienteAdicionaItemZeroQuantidade() {
        PratoDto pratoDTO = new PratoDto(p1.getNome(), p1.getCalorias(), p1.getPreco(),p1.getClassificacao(), getPortal().getRestauranteDoPrato(p1.getNome()));
        ...
        addItem = new AdicionarItemAoTabuleiroDeComprasService(pratoDTO, clienteDTO,quantidade_zero);
    ...
    public void testGestorAdicionaItem() {
        ...
        addItem = new AdicionarItemAoTabuleiroDeComprasService(pratoDTO, gestorDTO, quantidade_zero);
        try {
            addItem.execute();
    ...
    public void testAdicionarPratoInexistente() {
        Prato px = getPrato("cozido");
        PratoDto pratoDTO = new PratoDto(px.getNome(), px.getCalorias(), px.getPreco(),px.getClassificacao(), getPortal().getRestauranteDoPrato(px.getNome()));
        ClienteDto clienteDTO = new ClienteDto(cl1.get_nome(), cl1.get_username(),cl1.get_password(), cl1.get_morada(), cl1.get_email(), cl1.get_saldo());
        addItem = new AdicionarItemAoTabuleiroDeComprasService(pratoDTO, clienteDTO,quantidade_zero);
    }
    ...
    public void testAdicionarQuantidadePositiva() {
        PratoDto pratoDTO = new PratoDto(p1.getNome(), p1.getCalorias(), p1.getPreco(),p1.getClassificacao(), getPortal().getRestauranteDoPrato(p1.getNome()));
        ClienteDto clienteDTO = new ClienteDto(cl1.get_nome(), cl1.get_username(),cl1.get_password(), cl1.get_morada(), cl1.get_email(), cl1.get_saldo());
        addItem = new AdicionarItemAoTabuleiroDeComprasService(pratoDTO, clienteDTO,quantidade_two);
    ...
    public void testAdicionarQuantidadeNegativaMantendoQuantidadePositiva() {
        PratoDto pratoDTO = new PratoDto(p1.getNome(), p1.getCalorias(), p1.getPreco(),p1.getClassificacao(), getPortal().getRestauranteDoPrato(p1.getNome()));
        ClienteDto clienteDTO = new ClienteDto(cl1.get_nome(), cl1.get_username(),cl1.get_password(), cl1.get_morada(), cl1.get_email(), cl1.get_saldo());
        addItem = new AdicionarItemAoTabuleiroDeComprasService(pratoDTO, clienteDTO,quantidade_minusone);
    ...
    public void testAdicionarQuantidadeNegativaFicandoVazio() {
        PratoDto pratoDTO = new PratoDto(p1.getNome(), p1.getCalorias(), p1.getPreco(),p1.getClassificacao(), getPortal().getRestauranteDoPrato(p1.getNome()));
        ClienteDto clienteDTO = new ClienteDto(cl1.get_nome(), cl1.get_username(),cl1.get_password(), cl1.get_morada(), cl1.get_email(), cl1.get_saldo());
        addItem = new AdicionarItemAoTabuleiroDeComprasService(pratoDTO, clienteDTO,quantidade_minustwo);
