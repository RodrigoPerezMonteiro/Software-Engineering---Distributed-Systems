...
public class ListarPratosRestaurantePanel extends FlexTable{
    ...
    private Label lblNome,lblCalorias, lblPreco,lblClassificacao,lblQuantidade,lblAdicionar  ;
    ...
    private void addPratoTable(List<PratoDto> listPratos) {
        ...
        for (int i = 0; i < listPratos.size(); i++) {
            ...
            setWidget(i+1,4,btnAddPrato.getNewTextBox());
            setWidget(i+1,5,btnAddPrato.getNewButton());
        }
        for (int i = 0; i < 6; i++) {
