...
//			itemDTO = new ItemDto (new PratoDto(i.get_Prato().getNome(), i.get_Prato().getCalorias(), i.get_Prato().getPreco(), i.get_Prato().getClassificacao(), i.getPrato().getRestaurante().getNome()), i.getQuantidade());
