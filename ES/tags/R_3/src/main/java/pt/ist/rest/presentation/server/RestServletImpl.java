...
public class RestServletImpl extends RemoteServiceServlet implements RestServlet{
    ...
    @Override
	  public void adicionaPratoTabuleiro(PratoDto pratoDTO, UtilizadorDto utilizadorDTO, Integer quantidade){
	     // throws NameAlreadyExistsException, PersonDoesNotExistException { ALTERAR EXCEPÇOES
		AdicionarItemAoTabuleiroDeComprasService service = new AdicionarItemAoTabuleiroDeComprasService(pratoDTO, utilizadorDTO, quantidade);
	    service.execute();
	  }
