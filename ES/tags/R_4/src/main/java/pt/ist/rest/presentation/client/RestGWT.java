...
public class RestGWT implements EntryPoint {
        ...
        public void showTabuleiroCliente() {
            GWT.log("ENTREI NO showTabuleiroCliente");
            managementPage.hidePage();
            showNavigation();
            RootPanel.get("InformationContainer").add(managementPage.getListarTabuleiroComprasPanel());
            errorMessage.setText("");
        }
        
        public void showPratosPorNome(String nomePrato) {
            GWT.log("ENTREI NO showPratosPorNome");
            managementPage.hidePage();
            showNavigation();
            RootPanel.get("InformationContainer").add(managementPage.getListarPratosPorNomePanel(nomePrato));
            errorMessage.setText("");
        }
        
        public void showPratosPorTipo(String tipo) {
            GWT.log("ENTREI NO showPratosPorNome");
            managementPage.hidePage();
            showNavigation();
            RootPanel.get("InformationContainer").add(managementPage.getListarPratosPorTipoPanel(tipo));
            errorMessage.setText("");
        }
