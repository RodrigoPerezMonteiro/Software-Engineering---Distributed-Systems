...
public interface RestServletAsync {
	  ...
	  void listPratosPorNome(String nomePrato, AsyncCallback<List<PratoDto>> callback);
	  void listPratosPorTipo(String tipo, AsyncCallback<List<PratoDto>> callback);
	  void AlteraPrecoMaximo(double precoMaximo,AsyncCallback<Void> callback );
	  void PassaFatura(ClienteDto clienteDTO, AsyncCallback<Void> callback);
}
