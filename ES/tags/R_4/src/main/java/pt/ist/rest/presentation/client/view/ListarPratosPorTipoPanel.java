...
public class ListarPratosPorTipoPanel extends FlexTable{
    ...
    public ListarPratosPorTipoPanel( final RestServletAsync rpcService, final RestGWT rootPage) {
    ...
    public void listarPratos (String tipo, final RestServletAsync rpcService) {
        rpcService.listPratosPorTipo(tipo, new AsyncCallback<List<PratoDto>>() {
