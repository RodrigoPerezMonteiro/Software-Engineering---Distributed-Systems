...
public class ListarTabuleiroComprasPanel extends
        FlexTable {
    ...
    private Label lblNome, lblCalorias, lblPreco, lblClassificacao, lblQuantidade,
            lblAlteraQuantidade, lblAlterar;
        ...
        public Button getNewAlterarTabuleiroButton() {
            ...
            btnAlterarTabuleiro.addClickHandler(new ClickHandler() {
                public void onClick(ClickEvent event) {
                    ...
                    final PratoDto pratoDTO = new PratoDto(pratoName, pratoPreco, pratoCalorias,
                            pratoClass);

                    rpcService.adicionaPratoTabuleiro(pratoDTO, rootPage.getLoggedClient(),
                            novaQuantidade, true, new AsyncCallback<Void>() {
                                ...
                                public void onFailure(Throwable caught) {
                                    ...
                                    if (caught instanceof PratoNaoExisteEmRestauranteException) {
                                        ...
                                        rootPage.showErrorMessage("O prato '"
                                                + prNexiste.getIdPrato()
                                                + " nao existe no restaurante "
                                                + prNexiste.getNomeRestaurante());
                                    }
                                }
                            });
        ...
        btPagar.addClickHandler(new ClickHandler() {
            ...
            public void onClick(ClickEvent event) {
                ...
                if (!tbIdCheques.getValue().equals("")) {
                    GWT.log("nao esta vazia a textbox lista de cheques");
                    List<String> cheques = new ArrayList<String>();
                    cheques = new ArrayList<String>(Arrays
                            .asList(tbIdCheques.getValue().split(",")));
                    ...
                    rpcService.UsarChequeRefeicao(cDto, chequeDto, new AsyncCallback<Integer>() {
                        ...
                        public void onSuccess(Integer result) {
                            GWT.log("SUCESSO NO SERVICO USAR CHEQUE REFEICAO");
                            GWT.log("RESULT SERVICO USAR CHEQUE REFEICAO:\t" + result);
                            System.out.println("RESULT SERVICO USAR CHEQUE REFEICAO:\t" + result);
                            cDto.setSaldo((double) result);
                            ...
                            rpcService.ActualizaSaldoCliente(cDto, new AsyncCallback<Void>() {
                                ...
                                public void onSuccess(Void result) {
                                    ...
                                    rpcService.pagarTabuleiro(cDto.getUsername(),
                                            new AsyncCallback<Void>() {
                                                ...
                                                public void onFailure(Throwable caught) {
                                                    ...
                                                    if (caught instanceof restException) {
                                                        ...
                                                        rootPage.showErrorMessage("Erro ao pagar tabuleiro, o cliente: "
                                                                + clNex.getNomeCliente()
                                                                + " nao existe.");
                                                    }
                                                    if (caught instanceof restException) {
                                                        ClientESaldoInsuficienteException slInsuf = (ClientESaldoInsuficienteException) caught;
                                                        rootPage.showErrorMessage("Erro ao pagar tabuleiro, o cliente: "
                                                                + slInsuf.get_nomeCliente()
                                                                + " nao tem saldo suficiente, saldo do cliente: "
                                                                + String.valueOf(slInsuf
                                                                        .get_saldo()));
                                                    }
                                                    if (caught instanceof restException) {
                                                        NaoExisteTabuleiroException nExTab = (NaoExisteTabuleiroException) caught;
                                                        rootPage.showErrorMessage("Erro ao pagar tabuleiro, o cliente: "
                                                                + nExTab.getNomeCliente()
                                                                + " nao tem tabuleiro.");
                                                    }
                                                }
                                            });
                                ...
                                public void onFailure(Throwable caught) {
                                    ...
                                    if (caught instanceof restException) {
                                        ClienteNaoExisteException clNex = (ClienteNaoExisteException) caught;
                                        rootPage.showErrorMessage("Erro ao actualizar saldo, o cliente: "
                                                + clNex.getNomeCliente() + " nao existe.");
                                    }
                                }
                            });
                        }
                        ...
                        public void onFailure(Throwable caught) {
                            ...
                            if (caught instanceof restException) {
                                ...
                                rootPage.showErrorMessage("Erro ao pagar o tabuleiro: "
                                        + rExc.getMessage());
                            }
                        }
                    });
                    ...
                    rpcService.pagarTabuleiro(cDto.getUsername(), new AsyncCallback<Void>() {
                        ...
                        public void onSuccess(Void result) {
                            ...
                            rpcService.PassaFatura(cDto, new AsyncCallback<Void>() {

                                @Override
                                public void onSuccess(Void result) {
                                    GWT.log("SUCESSO NO SERVICO PASSAR FATURA");
                                }
                                @Override
                                public void onFailure(Throwable caught) {
                                    GWT.log("presentationserver.client.ListarTabuleiroCompras::onModuleLoad()::rpcService.PassaFatura");
                                    GWT.log("-- Throwable: '" + caught.getClass().getName() + " Message '"
                                            + caught.getMessage());
                                    
                                    if (caught instanceof restException) {
                                        restException rExc = (restException) caught;
                                        rootPage.showErrorMessage("Erro ao passar fatura: "
                                                + rExc.getMessage());
                                    }
                        ...
                        public void onFailure(Throwable caught) {
                            ...
                            if (caught instanceof restException) {
                                ...
                                rootPage.showErrorMessage("Erro ao pagar tabuleiro, o cliente: "
                                        + slInsuf.get_nomeCliente()
                                        + " nao tem saldo suficiente, saldo do cliente: "
                                        + String.valueOf(slInsuf.get_saldo()));
                            }
                            if (caught instanceof restException) {
                                NaoExisteTabuleiroException nExTab = (NaoExisteTabuleiroException) caught;
                                rootPage.showErrorMessage("Erro ao pagar tabuleiro, o cliente: "
                                        + nExTab.getNomeCliente() + " nao tem tabuleiro.");
                            }
                        }
                    });
                }
    ...
    private void addItemTable(List<ItemDto> listItens) {
        ...
        for (int i = 0; i < listItens.size(); i++) {
            ...
            GWT.log("CLASSIFICACAO " + String.valueOf(i) + ": "
                    + String.valueOf(listItens.get(i).getPratoDto().getClassificacao()));
