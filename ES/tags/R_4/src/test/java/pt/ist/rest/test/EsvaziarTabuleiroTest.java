...
public class EsvaziarTabuleiroTest extends
    ...
    protected void setUp() {
        ...
        try {
            ...
            p1 = new Prato("tchuca a la funes mori","Vegetariano", 3, 4, portal.generatePratoId());
            p2 = new Prato("Lasanha","Carne", 3, 3, portal.generatePratoId());
            p3 = new Prato("Tchica","Carne", 70, 1, portal.generatePratoId());
            p4 = new Prato("Prota","Carne", 7, 3, portal.generatePratoId());
            p5 = new Prato("Peixe embacalhau","Peixe", 8, 60, portal.generatePratoId());
    ...
    public void testEsvaziouTabuleiro() throws NaoExisteTabuleiroException, TabuleiroVazioException {
        ...
        port1.adicionaPratoCliente(p1, "Gancho", 100, false);
        port1.adicionaPratoCliente(p2, "Gancho", 120, false);
        port1.adicionaPratoCliente(p3, "Gancho", 90, false);
        port1.adicionaPratoCliente(p4, "Gancho", 50, false);
        port1.adicionaPratoCliente(p5, "Gancho", 70, false);
