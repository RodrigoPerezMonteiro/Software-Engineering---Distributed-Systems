...
protected void setUp() {
	...
	stringBuilder = new StringBuilder();
     ...
     try {
        Transaction.begin();
        p1 = new Prato("Bacalhau com Natas","Peixe", 2, 2, portal.generatePratoId());
        p2 = new Prato("Bacalhau a Bras","Peixe", 3, 3, portal.generatePratoId());
        p3 = new Prato("Carninha","Carne", 70, 1, portal.generatePratoId());
        p4 = new Prato("Carne de Vaca","Carne", 7, 3, portal.generatePratoId());
...
@Test
public void testStringMeio() throws PratoNaoExisteException {
...
@Test
public void testStringInicio() throws PratoNaoExisteException {
...
@Test
public void testStringInexistente() throws PratoNaoExisteException {
