...
public class RegistoFaturaCliente {
    ...
    public static void refreshPort() throws JAXRException {
		...
		do{
			...
			try{
				...
				if(option.equals("test")){
					...
					System.out.println("Introduza o numero de sequencia: ");
					String nrSequenciaS = scanIn.nextLine();
					...
					int nrSequenciaInt = Integer.parseInt(nrSequenciaS);
				    ...
				    fatura.setNumSeqFatura(nrSequenciaInt);
